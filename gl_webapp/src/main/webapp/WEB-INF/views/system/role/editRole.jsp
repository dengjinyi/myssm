...
<head>
	...
	<script src="${basePath}/js/system/role/editRole.js"></script>
</head>
<body>

	<ul class="nav nav-tabs">
		<li ><a href="${basePath}/role/list.do">用户列表</a></li>
		<li class="active"><a href="${basePath}/role/edit.do">
			<c:choose>
	...
	<form id="editForm" class="form-horizontal" action="save.do" method="post" novalidate="novalidate" style="margin-top:20px;">
		...
		<div class="form-group">
			<label class="col-sm-2 form-div control-label">归属机构:</label>
